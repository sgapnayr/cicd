...
_This starts the server in non-database mode._ It will serve a webpage at `http://localhost:8080`. However, you won't be able to interact with the webpage until you connect it to a MySQL database and run the migrations.
...
Add _your_ database connection string to your `.env` file. Here's an example:
...
_The purpose of this project is to just be a simple CRUD app that we can use to practice CI/CD. It's not meant to be a fully functional app._
